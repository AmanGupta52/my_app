...
function Service() {
  ...
  // Paths corresponding to your App.js routes
  const servicePaths = [
    "/motivation",
    "/counselling",
    "/career",
      ...
      <div className="services-page">
        ...
        <section className="text-center py-5 bg-white">
          ...
          <div className="container mt-4">
              ...
              {services.map((title, i) => (
                <div className="col-md-4 col-sm-6 mb-4" key={i}>
                  <div className="card h-100 shadow-sm p-3">
                    ...
                    <a href={servicePaths[i]} className="text-warning fw-semibold">
                      READ MORE &gt;
                    </a>
                  </div>
                </div>
            ...
            <p className="mt-4">
              Reach us at: <a href="mailto:believeconsultancy798@gmail.com">believeconsultancy798@gmail.com</a>
            </p>
          </div>
        </section>
        ...
        <section className="text-center py-5 text-white" style={{ backgroundColor: '#222' }}>
          <div className="container">
            ...
            <a href="/contact" className="btn btn-warning mt-3">CONNECT NOW</a>
          </div>
        </section>
        ...
        <section className="py-5 bg-light text-center">
          ...
          <div className="container mt-4 d-flex flex-wrap justify-content-center align-items-center">
            <img
              ...
              alt="Contact"
              className="img-fluid rounded shadow me-4"
              ...
              <div className="row mb-3">
                ...
                <div className="col">
                  <select className="form-select" required>
                    ...
                    {services.map((s, i) => (
                      <option key={i} value={servicePaths[i]}>{s}</option>
                    ))}
                  </select>
                </div>
              </div>
        ...
        <footer className="bg-dark text-white py-4">
          <div className="container d-flex flex-wrap justify-content-between">
            <div>
              ...
              <p style={{ maxWidth: '300px' }}>
                Believe Consultancy helps individuals and businesses achieve their full potential through expert guidance, motivational talks, and tailored solutions.
              </p>
            </div>
            <div>
          ...
          <div className="text-center mt-3 small">
            © Copyright 2025 Believe Consultancy. All Rights Reserved. | <a href="/contact">Need a Website?</a>
          </div>
        </footer>
      </div>
    </>
