...
router.post("/", async (req, res) => {
  try {
    const {
      fullName, email, age, issue,
      timingFrom, timingTo, expertId,
      meetingDate
    } = req.body;
    ...
    if (alreadyBooked) {
      return res.status(400).json({ message: "This time slot is already booked for this expert" });
    }
